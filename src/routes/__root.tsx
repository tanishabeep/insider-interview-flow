...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "IPM Ace Prep. Interview intelligence for IPMAT & IIM aspirants" },
      { property: "og:description", content: "An adaptive interview simulator built by an IIM student. Daily 2-minute current affairs quizzes, profile grilling, and real interview cross-questioning." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "IPM Ace Prep. Interview intelligence for IPMAT & IIM aspirants" },
      { name: "twitter:description", content: "An adaptive interview simulator built by an IIM student. Daily 2-minute current affairs quizzes, profile grilling, and real interview cross-questioning." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/896ce05e-360e-4aef-86c9-51988b67220a/id-preview-d81a3981--18c2dbd3-12ad-497f-b9b5-ec9af832ed9a.lovable.app-1778514572324.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/896ce05e-360e-4aef-86c9-51988b67220a/id-preview-d81a3981--18c2dbd3-12ad-497f-b9b5-ec9af832ed9a.lovable.app-1778514572324.png" },
